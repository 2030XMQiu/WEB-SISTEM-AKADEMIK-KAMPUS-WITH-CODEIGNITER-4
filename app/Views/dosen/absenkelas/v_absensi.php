<section class="content-header">
    <h1>
        <?=$title?> Kelas : <?=$jadwal['nama_kelas']?>-<?=$jadwal['tahun_angkatan']?> TA :
        <?=$ta['ta']?>/<?=$ta['semester']?>
    </h1>
    <br>
    <ol class="breadcrumb">
...
<div class="row">
    ...
    <div class="col-sm-12">
        <a href="<?=base_url('dsn/print_absensi/' . $jadwal['id_jadwal'])?>" target="_blank"
            class="btn btn-xs btn-flat btn-success"><i class="fa fa-print"></i> Print Absensi</a>
    </div>
    <div class="col-sm-12">
        <?php
