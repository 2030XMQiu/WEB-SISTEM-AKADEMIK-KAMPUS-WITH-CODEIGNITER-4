        ...
        <div class="box box-primary box-solid">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a href="<?=base_url('mahasiswa/add')?>" class="btn btn-box-tool"><i class="fa fa-plus"></i>
                        Add</a>
                </div>
                <!-- /.box-tools -->
            </div>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Nama Mahasswa</th>
...
foreach ($mhs as $key => $value) {?>
                        <tr>
                            ...
                            <td class="text-center"><img src="<?=base_url('fotomhs/' . $value['foto_mhs'])?>"
                                    class="img-circle" width="70px" height="70px"></td>
                            <td class="text-center">
                                <a href="<?=base_url('mahasiswa/edit/' . $value['id_mhs'])?>"
                                ...
                                <button class="btn btn-danger btn-sm btn-flat" data-toggle="modal"
                                    data-target="#delete<?=$value['id_mhs']?>"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                        <?php }?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?=base_url('mahasiswa/delete/' . $value['id_mhs'])?>"
