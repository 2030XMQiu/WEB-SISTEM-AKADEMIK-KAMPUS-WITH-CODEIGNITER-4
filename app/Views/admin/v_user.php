...
foreach ($user as $key => $value) {?>
                        <tr>
                            ...
                            <td class="text-center"><img src="<?=base_url('foto/' . $value['foto'])?>"
                                    class="img-circle" width="70px" height="70px"></td>
                            <td class="text-center">
                                <button class="btn btn-warning btn-sm btn-flat" data-toggle="modal"
                                    data-target="#edit<?=$value['id_user']?>"><i class="fa fa-pencil"></i></button>
...
echo form_open_multipart('user/edit/' . $value['id_user']);
    ?>
                ...
                <div class="form-group">
                    <img src="<?=base_url('foto/' . $value['foto'])?>" class="img-circle" width="100px"
                        height="100px">
                </div>
