...
?>
                ...
                <table class="table table-bordered ">
                    <tr>
                        <th width="50px" class="text-center label-primary">NO</th>
                        <th width="100px" class="text-center label-primary">NIM</th>
                        <th class="label-primary">Nama Mahasiswa</th>
                        <th width="50px" class="text-center label-primary">Action</th>
                    </tr>
                    <?php $no = 1;
foreach ($mhs as $key => $value) {?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?=base_url('kelas/remove_anggota_kelas/' . $value['id_mhs'] . '/' . $kelas['id_kelas'])?>"
...
foreach ($mhs_tpk as $key => $value) {?>
                        ...
                        <tr>
                            ...
                            <td><?=$value['prodi']?></td>
                            <td class="text-center">
                                <a href="<?=base_url('kelas/add_anggota_kelas/' . $value['id_mhs'] . '/' . $kelas['id_kelas'])?>"
                                    class="btn btn-success btn-xs"><i class="fa fa-plus"></i></a>
                            </td>
                        </tr>
                        <?php }?>
                        <?php }?>
