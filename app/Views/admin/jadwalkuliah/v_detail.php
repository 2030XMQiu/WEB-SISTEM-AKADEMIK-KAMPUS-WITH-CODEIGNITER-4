                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-danger btn-sm btn-flat" data-toggle="modal"
                                    data-target="#delete<?=$value['id_jadwal']?>"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                        <?php }?>
                    </tbody>
...
?>
                ...
                <div class="form-group">
                    ...
                    <select name="id_matkul" class="form-control">
                        ...
                        <option value="<?=$value['id_matkul']?>"><?=$value['smt']?> | <?=$value['kode_matkul']?> |
                            <?=$value['matkul']?> | <?=$value['sks']?> SKS</option>
                        <?php }?>
                        <?php }?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="id_kelas" class="form-control">
                        ...
                        <option value="<?=$value['id_kelas']?>">
                            <?=$value['nama_kelas']?>-<?=$value['tahun_angkatan']?></option>
                        <?php }?>
                    </select>
                </div>
...
<div class="modal fade" id="delete<?=$value['id_jadwal']?>">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger pull-left btn-flat" data-dismiss="modal">Close</button>
                <a href="<?=base_url('jadwalkuliah/delete/' . $value['id_jadwal'] . '/' . $prodi['id_prodi'])?>"
