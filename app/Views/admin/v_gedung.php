                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button class="btn btn-warning btn-sm btn-flat" data-toggle="modal"
                                    data-target="#edit<?=$value['id_gedung']?>"><i class="fa fa-pencil"></i></button>
                                <button class="btn btn-danger btn-sm btn-flat" data-toggle="modal"
                                    data-target="#delete<?=$value['id_gedung']?>"><i class="fa fa-trash"></i></button>
                            </td>
                        </tr>
                        <?php }?>
...
echo form_open('gedung/edit/' . $value['id_gedung']);
    ?>
                ...
                <div class="form-group">
                    <label>Gedung</label>
                    <input name="gedung" value="<?=$value['gedung']?>" class="form-control" placeholder="Fakultas"
                        required>
                </div>
